...
//        height = getHeight() / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制方块
        canvas.drawRect(width / 2 - 150, height / 2, width / 2 - 100, height / 2 + 30, mPaint);
        // 绘制文字
        canvas.drawText("五", width / 2 - 135, height / 2 + 25, mTextPaint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (x > width / 2 - 150 && x < width / 2 - 100 && y > height / 2 && y < height / 2 + 30) {
